...
echo ""
echo -e "[Turing Cluster Profile Report]\n"
...
echo "OVERLOADED NODES (Note: Threshold = 1 CPU/SLOT)"
echo ""
...
echo "Total jobs in 7 days = "$wtjobs 
echo ""
...
echo "Grid Engine (SGE) Parallel Environment Stats"
echo ""
...
echo "Total jobs in 30 days = "$mtjobs 
echo ""
...
echo "Total jobs in 180 days = "$sixmtjobs 
echo ""
...
echo ""
##Prints the parallel enviroments (PE's) used with job data
echo "Grid EnginGE)SGE) Parallel Environment Stats"
